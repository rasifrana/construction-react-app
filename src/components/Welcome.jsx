...
const Welcome = () => {
    ...
    return (
        <section className="w-full bg-cover bg-center" style={{ backgroundImage: `url(${img})`, height: '800px' }}>
            <div className="layer h-full bg-gradient-to-b from-blue-800">
                <div className="lg:w-3/4 mx-auto h-full text-white text-center py-16 pt-40">
